...
class TestTranscribationTask:
    ...
    def test_post_success(
        ...
        mock_TableManager: MagicMock | AsyncMock,
        mock_os_path: MagicMock | AsyncMock,
        mock_transcribation_task: MagicMock | AsyncMock,
        mock_shutil: MagicMock | AsyncMock,
        mock_open_file: MagicMock | AsyncMock,
        mock_requests: MagicMock | AsyncMock,
        ...
        # arrange
        mock_TableManager.create_task_backup.return_value = None
        mock_os_path.return_value = True
        mock_transcribation_task.return_value = None
        mock_response = Mock()
    ...
    @pytest.mark.parametrize(
        ...
        [
            ('test.mp3', None),
            (None, 'https://raw.githubusercontent.com/CaptainUES69/test/refs/heads/main/test.mp3')
        ]
    )
...
class TestGetDataFromTask:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (celerys[2].task_id, celerys[2].result)
        ]
    )
    def test_get_success(
        self,
        testclient: TestClient,
        mock_delete_task: MagicMock | AsyncMock,
        mock_delete_task_backup: MagicMock | AsyncMock,
        conf_TB: None,
        task_id: str,
